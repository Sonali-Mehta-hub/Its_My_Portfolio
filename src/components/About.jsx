    ...
    <section id="about" className="about-section">
      ...
      <div className="about-left">
        ...
        <div className="avatar-ring">
          <img src={about.avatar} alt={about.name} className="avatar-img" />
        </div>
        ...
        <div className="about-role">FULL_STACK_DEV + ML_EXPLORER()</div>
        ...
        <div className="about-btns">
          ...
          <button onClick={onContactClick} className="btn-contact">
            ✉ CONTACT ME
          </button>
        </div>
      ...
      <div className="about-right">
        ...
        <p className="about-bio">
          I am a <strong> Final Year(Computer Science and Engineering) student</strong> at{" "}
        ...
        <p className="about-bio">
          ...
          completed an internship at <strong>IBM SkillsBuild</strong> working on
          AI/ML projects. Currently exploring{" "}
          <strong>Machine Learning &amp; Generative AI</strong>.
        </p>

        {/* Open to internships badge */}
        <div className="open-badge">🚀 Open to {about.openTo}</div>
